(function(global2, factory) {
  ...
  var __publicField = (obj, key, value) => {
        ...
        return (
          ...
          function(modules) {
            ...
            function(module3, exports3, __webpack_require__) {
              ...
              }).call(exports3, __webpack_require__(1), function() {
                return this;
    ...
    function isEsmScript(js2) {
      return js2.includes("_scriptDir = import.meta.url");
    }
    ...
    class Emulator {
      ...
      get stateFileName() {
        ...
        const baseName2 = fileName.slice(0, fileName.lastIndexOf("."));
        const coreFullName = coreInfoMap[core.name].corename;
        if (!coreFullName) {
          throw new Error(`invalid core name: ${core.name}`);
        }
        return `${raUserdataDir}states/${coreFullName}/${baseName2}.state`;
      }
      ...
      async saveState() {
        ...
        const thumbnail = stateThumbnailBuffer ? new Blob([stateThumbnailBuffer], blobProperty) : void 0;
  ...
  `);
    ...
    const _Nostalgist = class _Nostalgist {
      ...
      async getCoreOption() {
        ...
        const coreDict = typeof core === "string" ? { name: core, js: await resolveCoreJs(core, this.options), wasm: await resolveCoreWasm(core, this.options) } : core;
        let { name: name2, js: js2, wasm } = coreDict;
        if (typeof js2 === "string") {
          const response = await fetch(js2);
